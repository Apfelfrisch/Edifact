...
class StreamTest extends TestCase
{
    ...
    public function testCanInstantiteWithStreamResource()
    {
        ...
        $stream = new EdifactFile($resource);
        $this->assertInstanceOf('Proengeno\Edifact\EdifactFile', $this->stream);
    }
    ...
    {
        $stream = new EdifactFile('php://memory', 'r');
    ...
    public function testPassingInvalidStreamResourceToConstructorRaisesException()
    {
        ...
        $stream = new EdifactFile(['  THIS WILL NOT WORK  ']);
    }
    ...
    {
        $stream = new EdifactFile("php://temp", "r+b");
    ...
    {
        $stream = new EdifactFile('php://memory', 'r');
        $this->setExpectedException('RuntimeException', 'EdifactFile is not writable');
        $stream->write('bar');
    }
    ...
    public function testRaisesExceptionOnAttachForNonStreamResources()
    {
        ...
        $stream = new EdifactFile(__FILE__);
